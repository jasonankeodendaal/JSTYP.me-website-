                ...
                <main className="px-4 md:px-8 pt-32 pb-16">
                    <div className="container mx-auto">
                        <div className="flex justify-between items-start mb-10">
                            ...
                            <ReactRouterDom.Link to="/" className="bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg transition-colors flex items-center gap-2 flex-shrink-0">
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-10 border-2 border-dashed border-[var(--border-color)] rounded-xl">
                                ...
                                <ReactRouterDom.Link to="/" className="mt-4 inline-block text-orange-500 font-bold hover:underline">Explore Apps</ReactRouterDom.Link>
                            </div>
                        )}
                    </div>
                </main>
