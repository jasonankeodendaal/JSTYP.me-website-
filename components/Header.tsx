    ...
    return (
        <header className={`py-6 px-4 md:px-8 z-20 ${sticky ? 'sticky top-0 bg-[var(--background-color)]/50 backdrop-blur-sm border-b border-[var(--border-color)]' : 'absolute top-0 left-0 right-0'}`}>
            <div className="container mx-auto flex justify-between items-center">
                <Link to="/" className="flex items-center gap-3 text-3xl font-bold focus:outline-none focus:ring-2 focus:ring-orange-500 rounded-lg">
                ...
                <div className="flex items-center gap-4">
                    {currentUser ? (
                        <>
                            <Link to="/dashboard" className="font-bold text-[var(--text-color)] hover:text-orange-400 transition-colors">Dashboard</Link>
                        ...
                        <Link to="/about" className="bg-orange-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-orange-600 transition-colors">About Us</Link>
                    )}
                     <button
