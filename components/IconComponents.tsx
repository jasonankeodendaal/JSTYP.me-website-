...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-11a3 3 0 013 3h4a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1m-9 3a3 3 0 013-3h4a3 3 0 013 3v4a3 3 0 01-3 3h-4a3 3 0 01-3-3v-4z" />
    </svg>
);
...
export const AndroidIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 19v-3a2 2 0 00-2-2H9a2 2 0 00-2 2v3m-3 0h14M16 5l-1-1-1 1M8 5l1-1 1 1m-5 4h14a2 2 0 012 2v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-3a2 2 0 012-2z" />
    </svg>
);

export const AppleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M19.73 14.73c-1.33 2.3-2.9 3.47-4.96 3.47-1.93 0-2.83-1.1-4.36-1.1s-2.5.96-4.26.96c-2.2 0-3.96-1.5-5.13-4.2s.3-5.5 2.13-7.3c1.1-1.13 2.6-1.8 4.2-1.8 1.8 0 2.8 1.13 4.33 1.13s2.4-1.23 4.2-1.23c1.43 0 2.8.5 3.86 1.6.1.13-1.53 2.3-1.53 4.23 0 2.3 1.8 3.3 1.96 3.43zM14.76 5.4c.83-.93 1.3-2.13 1.2-3.33-.03 0-2.2.8-3.06 1.8-.73.9-.13 2.1.06 3.23.8.2 2.1-.83 1.8-1.7z"/>
    </svg>
);

export const GlobeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.938 6.063a9 9 0 108.124 0M12 21a9 9 0 00-9-9h18a9 9 0 00-9 9z" />
    </svg>
);
...
export const KeyIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7a2 2 0 012 2v1a2 2 0 01-2 2H9a2 2 0 01-2-2V9a2 2 0 012-2h6zM15 7V5a2 2 0 00-2-2H9a2 2 0 00-2 2v2m0 4h6m-6 4v2a2 2 0 002 2h2a2 2 0 002-2v-2" />
    </svg>
);

export const BuildingStorefrontIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.5a.75.75 0 01.75.75V21m-4.5 0V16.5a.75.75 0 01.75-.75h.5a.75.75 0 01.75.75V21m-4.5 0V12a.75.75 0 01.75-.75h.5a.75.75 0 01.75.75V21m-4.5 0V16.5a.75.75 0 01.75-.75h.5a.75.75 0 01.75.75V21m6.75-13.5l-4.5-3-4.5 3m11.25 0l-4.5 3-4.5-3m.225 13.5c-.58.58-1.52.58-2.1 0l-2.1-2.1c-.58-.58-.58-1.52 0-2.1l2.1-2.1c.58-.58 1.52-.58 2.1 0l2.1 2.1c.58.58.58 1.52 0 2.1l-2.1 2.1z" />
    </svg>
);
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 016-6h6M21 21h-3v-1a6 6 0 00-6-6h-3" />
    </svg>
);
